...
// mvn: <<
// import {showPishrobotAlert} from '../reducers/alerts';
// mvn: >>
...
// mvn: <<
var onClickPishrobotLogo = function onClickPishrobotLogo() {
  window.location = 'https://www.pishrobot.com';
};
...
var handleClickHelp = function handleClickHelp() {
  window.location = 'https://www.pishrobot.com/help';
};
// mvn: >>
...
/* harmony default export */ __webpack_exports__["default"] = (function (appTarget) {
  ...
  simulateScratchDesktop ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(WrappedGui, {
    ...
    // mvn: <<
    ,
    onClickPishrobotLogo: onClickPishrobotLogo,
    onClickAbout: [
    // {
    //     title: 'About',
